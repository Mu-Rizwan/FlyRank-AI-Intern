...
*If you completed the AI rematch, fill in this section:*

- **My prompt**:  
  *(paste your exact prompt here)*

- **What the AI did better**:  
  *(e.g., cleaner error handling, more concise code, etc.)*

- **What the AI got wrong / ignored**:  
  *(e.g., missed the 400 validation, used 422 instead, added a database, etc.)*

- **What my prompt forgot to specify**:  
  *(e.g., forgot to mention that `title` must be trimmed, or forgot to specify the `204` status for DELETE)*

- **After the rematch**:  
  *(one sentence about what improved in the second generation)*
